...
class EntityAttributeServiceTests {
    ...
    fun `it should partially update the default instance of property`() {
        ...
        val expandedPayload = expandAttributeFragment(propertyName, payload, listOf(AQUAC_COMPOUND_CONTEXT))
    ...
    fun `it should partially update the default instance of relationship`() {
        ...
        val expandedPayload = expandAttributeFragment(relationshipType, payload, listOf(AQUAC_COMPOUND_CONTEXT))
